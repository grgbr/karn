# -*- coding: utf-8 -*-
#
# Karn documentation build configuration file, created by
...
# Breathe Sphinx / Doxygen bridge setup
#breathe_projects = { "Karn": "../build/doc/doxygen/xml" }
breathe_projects = { "Karn": os.environ['DOXYBUILD'] }
breathe_default_project = "Karn"
...
project = u'Karn'
copyright = u'2017, Grégor Boirie'
...
# Alabaster theme setup
#html_theme = 'alabaster'
#html_theme_options = {
#    'logo_name': True,
#    'description': 'Data structures and algorithms toolbox for C',
#    'github_banner': False,
#    'github_button': False,
...
#
#html_sidebars = {
#    '**': ['about.html', 'searchbox.html', 'navigation.html', 'relations.html']
#}

# Read the docs theme setup
...
default_domain = 'c'
cpp_id_attributes = ["__unused", "restrict"]
...
latex_documents = [
    (master_doc, 'Karn.tex', u'Karn Documentation',
     u'Grégor', 'manual'),
]
...
man_pages = [
    (master_doc, 'karn', u'Karn Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Karn', u'Karn Documentation',
     author, 'Karn', 'One line description of project.',
     'Miscellaneous'),
]
...
def setup(app): 
    app.add_stylesheet('css/karn.css') 
